...
Nachdem im letzten Abschnitt eine Festlegung auf spezifischen Kriterien zur Erhebung von Messwerten vorgenommen wurde, folgt eine detailierte Beschreibung der Implementierung des zu erstellenden Prototypen. Der komplette Quellecode sowie alle zugehörigen Konfigurationsdateien befinden sich in einem Github-Repository unter folgender url \url{} \todo{url einfügen}.
