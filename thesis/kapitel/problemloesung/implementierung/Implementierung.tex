...
Neben den wesentlichen beschriebenen Konfigurationsparameter gilt es noch die \emph{volume} Definition hervorzuheben (siehe Listing \ref{lst:composeVolumes}) zu erwähnen. 
...
Volumes stellen eine Möglichkeit dar, um Daten auf dem Datenträger des Hosts zu persistieren. Hierbei gibt es zwei Varianten. 
