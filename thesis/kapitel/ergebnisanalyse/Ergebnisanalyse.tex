...
\todo{Spring Initialisierungsschritte mit Node.js vergleichen}
...
\todo{Docker Container Initialisierungszyklus recherchieren -> warum dauert das Initialisieren mehrere Container so viel länger als einzelner Container}
...
Ein Werkzeug zum Testen dieses Verhaltens nennt sich "\emph{Chaos Monkey}"\footnote{\url{https://github.com/Netflix/chaosmonkey}}. 




Sobald ein System jedoch skaliert wurde und eine Verbindung zwischen kommunizierenden Komponenten besteht, 
...
\begin{itemize}
	\item Ressourcenoptimierung könnte 
	\item
	\item
	\item
\end{itemize}
