...
%% Document properties %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\projname}{Serverless Vergleich Applicationserver}
\newcommand{\titel}{Vergleich eines Usecases mit Serverless Technologie gegen\"uber Java Enterprise Technologie}
